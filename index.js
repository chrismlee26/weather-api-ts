...
//  the actual function that runs will be here
//  getWeatherByGeo(latitude, longitude, api__key) {

//    if (!navigator.geolocation) {
//     what is the if condition?
//    } else {
//      descEl.innerHTML = 'ERROR, Please enter a 5 Digit Zip Code, City Name or Latitude, Longitude'; <------ this will be error handler
//    }
//  }
// Create the #find-me id, choose how it works.
